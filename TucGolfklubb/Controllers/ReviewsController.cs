...
namespace TucGolfklubb.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,ProductId,Comment,Rating,Date")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,ProductId,Comment,Rating,Date")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
