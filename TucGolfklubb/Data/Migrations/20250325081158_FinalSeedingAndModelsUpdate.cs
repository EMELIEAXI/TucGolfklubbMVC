...
{
    /// <inheritdoc />
    public partial class FinalSeedingAndModelsUpdate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Komplett set med järnklubbor för nybörjare och proffs.", "Callaway Järnset", 5999.00m },
                    { 2, 2, "Tourklassad golfboll med maximal kontroll och känsla.", "Titleist Pro V1", 549.00m },
                    { 3, 3, "Andningsaktiv piké perfekt för varma golfrundor.", "Puma Golf Pikétröja", 399.00m }
                });
